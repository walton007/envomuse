...
app.controller('UserCalendarCtrl', ['$scope', '$stateParams', '$window',
  function($scope, $stateParams, $window) {  

    $scope.init = function(){

      $scope.playlist = $window.myInfo.dayPlaylistArr;
      console.log($scope.playlist);

      var events = [];
      var colorBars = ['b-l b-b b-3x b-info',
                       'b-l b-b  b-3x b-primary',
                       'b-l b-b  b-3x b-danger',
                       'b-l b-b  b-3x b-success',
                       'b-l b-b  b-3x b-warning'];
      var colorIndex = 0;
          ...
          for(var j=0,track_size=$scope.playlist[i].playlist.length;j<track_size;j++){
            ...
            if(events.length>0){
              ...
              if(lastEvent.title===track.fromBoxs[0] && lastEvent.dateString===dt){
                ...
                if(colorIndex==(colorBars.length-1))
                  colorIndex=0;
